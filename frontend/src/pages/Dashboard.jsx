  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="flex items-center gap-3 px-5 py-3 bg-white border-b border-slate-200 overflow-x-auto">
        ...
        <div className="ml-auto shrink-0 flex items-center gap-1.5 bg-amber-50 border border-amber-200 rounded-md px-3 py-1.5 text-[12px] text-amber-700 font-medium">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="bg-white border-t border-slate-200 px-5 py-3 flex items-center gap-6">
            {/* Mini charts */}
            <div className="flex-1">
              <div className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-1">Reports over time</div>
              <ReportsTimeChart reports={filteredReports} />
            </div>
            <div className="w-px h-24 bg-slate-200" />
            <div>
              <div className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-1">Evidence composition</div>
              <EvidenceDonut reports={filteredReports} />
            </div>
            {/* Quick tagline */}
            <div className="w-px h-24 bg-slate-200" />
            <div className="max-w-[200px]">
              <div className="text-[12px] font-semibold text-slate-600 mb-1">Independent evidence matters</div>
